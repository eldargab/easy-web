...
app.def('sendHttpException', function(res, send) {
  return function sendHttpException(e) {
    util.setHeaders(res, e.headers)
    let msg = e.message || statuses.STATUS_CODES[e.statusCode]
    return send(e.statusCode, 'text/plain', msg)
  }
})
