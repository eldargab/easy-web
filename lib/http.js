...
app.def('requestProcessing', function*(evaluate, req, res, onHttpException, sendStatus, route$, sendResult$) {
  try {
...
app.def('onHttpException', function(res, sendStatus) {
...
app.def('onServerError', function(logServerError, sendStatus, exposeServerError, res) {
